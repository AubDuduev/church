...
class AlertEK {
  ...
  //MARK: - Default
  static public func dеfault(title: Texts.Title, message: Texts.Message, completion: @escaping ClousureEmpty = {}){
  ...
  static func customText(title: Texts.Title, message: Texts.MessageCustom, completion: @escaping ClousureEmpty = {}){
    var messageCustom = ""
    switch message {
  ...
  //MARK: - Options
  static func options(title: Texts.Title, message: Texts.Message, options: AlertButtonOptions.Types, completion: @escaping Clousure<Int>){
